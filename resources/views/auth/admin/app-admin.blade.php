        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ route('index') }}" class="site_title"><i class="fa fa-wordpress"></i> <span>Blog Post</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-list-alt"></i> Posts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('data-posts.index') }}">Data Posts</a></li>
                      <li hidden><a href="#">Hidden Posts</a></li>
                      <li hidden><a href="#">Trash Posts</a></li>
                    </ul>
                  </li>
